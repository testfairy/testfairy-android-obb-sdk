...
public class TestFairyApkExpansionPolicy extends APKExpansionPolicy {
	...
	public TestFairyApkExpansionPolicy(Context context, Obfuscator obfuscator, OBBData[] obbs) {
